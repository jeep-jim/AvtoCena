...
for(const [market,workflow] of Object.entries(MARKET_WORKFLOWS)){
 ...
 if(['storage_pressure_requires_attention','deterministic_or_unclassified_failure','retry_limit_reached','source_retry_limit_reached','source_failure_requires_attention','old_failed_run_requires_new_schedule','budget_continuation_blocked','budget_continuation_no_progress'].includes(decision.reason))process.exitCode=1;
