...
globalThis.fetch = async (input, init = {}) => {
  ...
  if (/captcha|verify you are human|访问验证|安全验证/i.test(body)) throw new Error('pilot_challenge_stop');
  return response;
};
...
const sources = [
  ...
  ['uae', 'dubizzle-exact-source', 'dubizzleUaeExactSource', ['dubizzle.com']],
