...
const report={startedAt:new Date().toISOString(),available:rows.length,previouslyPowered:rows.filter(row=>Number(row.powerHp)>0).length,withBoundInspection:0,matched:0,lowPower:0,calculated:0,prepared:0,remaining:0,errors:[],sample:[]};
