...
BRANCH = "fix/russia-utilization-2026-coefficients-20260825"
SOURCE = "packages/engine/src/calculation/russiaCustoms.ts"
TESTS = "tests/russia-customs.test.ts"
HELPER = ".github/workflows/zz-temp-apply-utilization-repair.yml"
SELF = "scripts/zz-repair-utilization-fix.py"
...
// Используем пару коэффициентов 01.01.2026–31.12.2026; следующая годовая пара
// официальной таблицы относится уже к 2027 году. Границы мощности указаны в кВт.
const EV_2026 = rows([
...
swaps = {
    ...
    'assert.equal(result.utilizationCoefficient, 54.52);': 'assert.equal(result.utilizationCoefficient, 49.56);',
    'assert.equal(result.totalCustomsRub, 1_620_324);': 'assert.equal(result.totalCustomsRub, 1_521_124);',
