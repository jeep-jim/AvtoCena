...
> **Продолжение проекта / новый чат:** сначала читать актуальное состояние и решения владельца в начале [roadmap.md](roadmap.md), затем связанные документы и свежие результаты проверок. Исторические описания источников и расписаний ниже не заменяют текущий roadmap.
