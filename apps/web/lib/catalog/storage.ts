...
export async function searchOffers(params: CatalogSearchParams) {
  ...
  const hasRangeFilters = Boolean(params.budgetTo || params.yearFrom || params.yearTo || params.mileageTo || params.engineFrom || params.engineTo || params.powerFrom || params.transmission || params.auctionGrade || (params.sort && params.sort !== "updatedAt"));
