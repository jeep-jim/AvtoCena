  ...
  normalizeOffer(raw: unknown): VehicleOffer | null {
    ...
    return {
      ...
      operational: {
        ...
        sourceOnlyFieldsPreserved: true, auctionResultPriceVerified: true, resultPriceVerified: true, galleryVerified: row.images.length >= 5, gallerySafetyMode: "prestige_ajes_exact_detail_v1",
        raw: { detailIdentityVerified: true, photoIdentityVerified: true, listingBoundImages: true, carId: row.carId, currentStatus: row.currentStatus, finalPriceJpy: row.finalPrice, startPriceJpy: row.startPrice, fields: row.rawFields, images: row.images },
      },
    };
  }
