...
// 1000 — только ориентир глубины ежедневного обхода, а не лимит публикации.
// Внутри рынка приоритетные машины идут первыми, после них публикуются все остальные
// проверенные предложения, пока не достигнут технический предел 100 000 записей.
