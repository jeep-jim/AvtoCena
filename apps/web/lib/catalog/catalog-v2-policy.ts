...
export const CATALOG_V2_DEFAULT_POLICY: CatalogV2PolicyOptions = { priorityTarget: 0, maximumPerMarket: 30_000, priorityMaxAgeYears: 6, recentMaxAgeYears: 15, priorityMaxPowerHp: 160, priorityMaxTotalRub: 6_000_000, hardMaxTotalRub: Number.MAX_SAFE_INTEGER };
...
export function classifyCatalogV2Offer(offer: Partial<VehicleOffer>, options: CatalogV2PolicyOptions = CATALOG_V2_DEFAULT_POLICY): CatalogV2Classification {
  ...
  return priority
    ...
    : { tier: "recent", eligible: true, reason: "listing_2011_plus", ageYears, powerHp, totalRub, popularityDecile: popularity };
}
...
export function selectCatalogV2MarketOffers(offers: VehicleOffer[], options: CatalogV2PolicyOptions = CATALOG_V2_DEFAULT_POLICY): CatalogV2Selection {
  ...
  const selected = accepted.slice(0, Math.max(1, Number(options.maximumPerMarket || 30_000)));
  return {
    selected,
