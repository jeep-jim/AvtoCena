...
type RateExtras = Awaited<ReturnType<typeof readPublicRateExtras>>;
let extrasCache: { value: RateExtras; expiresAt: number } | null = null;
let extrasPromise: Promise<RateExtras> | null = null;

export async function loadPublicRateExtras(): Promise<RateExtras> {
