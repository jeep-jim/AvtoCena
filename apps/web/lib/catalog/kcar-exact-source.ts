...
class KCarExactSource implements CatalogSourceAdapter {
  ...
  normalizeOffer(raw: unknown): VehicleOffer | null {
    ...
    return {
      ...
      powerHp: row.powerHp,
      powerKw: row.powerKw,
      powerDataConfidence: row.powerHp || row.powerKw ? "source_exact" : undefined,
      powerDataSource: row.powerKw ? "kcar_exact_detail_rvo_hrspow_kw" : row.powerHp ? "kcar_exact_detail_rvo_hrspow_hp" : undefined,
      fuel: row.fuel,
