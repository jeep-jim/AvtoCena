...
export const CATALOG_V2_SOURCE_SLOTS: Record<CatalogMarket, readonly CatalogV2SourceSlot[]> = {
  ...
  china: [
    { sourceId: "autohome_used_china_open", label: "Che168 / Autohome Used", role: "primary" },
    { sourceId: "guazi_china_open", label: "Guazi", role: "primary" },
    { sourceId: "taoche_china_open", label: "Taoche", role: "secondary" },
  ...
  europe: [
    { sourceId: "mobile_de_open", label: "mobile.de", role: "primary" },
    { sourceId: "autoscout_europe_open", label: "AutoScout24", role: "primary" },
    { sourceId: "otomoto_europe_exact", label: "OTOMOTO", role: "primary" },
    { sourceId: "lacentrale_fr_open", label: "La Centrale", role: "secondary" },
    { sourceId: "leboncoin_fr_open", label: "Leboncoin", role: "secondary" },
  ],
  georgia: [
    { sourceId: "myauto_georgia_list", label: "MyAuto", role: "primary" },
