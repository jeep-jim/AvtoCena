...
export const CRM_PERMISSIONS = {
 ...
 staff:{label:'Управление сотрудниками',description:'Для администратора: создание сотрудников, изменение прав и выдача ключей. Изменять владельцев может только владелец.'},
