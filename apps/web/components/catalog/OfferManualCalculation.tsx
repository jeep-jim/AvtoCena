...
export function OfferManualCalculation({offerId,year,researchIdentity}:{offerId:string;year:number;researchIdentity?:VehicleResearchIdentity}) {
  ...
  return <div className="py-3">
    ...
    <OfferCalculationForm offerId={offerId} initial={{year:String(year)}} researchIdentity={researchIdentity} onCalculate={calculate} onDraftChange={()=>{setResult(null);setError("");}} pending={pending} error={error}/>
