...
export function ContractPaymentSummary({ plan }: { plan?: BusinessPaymentPlan | null }) {
  ...
  return <div data-payment-kind="security-deposit" data-payment-amount-rub={plan.securityDepositRub} className="grid grid-cols-[minmax(0,1fr)_auto] items-baseline gap-2 px-4 py-1.5 text-[12px] font-medium md:text-[13px]">
