...
export function LoginForm({ nextPath, errorCode = "", botUsername = "" }: { nextPath: string; errorCode?: string; botUsername?: string }) {
  ...
  return (
    <div className="glass ac-login-card mx-auto w-full max-w-[460px] rounded-[2rem] p-5 md:p-6">
      ...
      <h1 className="text-2xl font-black">Вход для команды</h1>
      <p className="mt-2 text-sm text-[var(--ac-muted)]">Введите свой Telegram username и персональный ключ доступа.</p>
      <div className="ac-login-details mt-4 rounded-2xl border border-white/10 p-4">
