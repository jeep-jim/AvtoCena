...
export default async function CrmSettingsPage({ searchParams }: { searchParams?: Promise<SearchParams> }) {
  ...
  return (
    <CrmShell activeHref="/crm/settings" title="Рынки и расчёт" subtitle="Сверху — живой контроль того же расчётного ядра, которым считаются карточки сайта: можно ввести контрольные исходные данные и увидеть каждый этап. Ниже — коммерческие расходы семи рынков; таможня и утильсбор считаются отдельно по характеристикам конкретной машины.">
