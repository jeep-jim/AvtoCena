...
export default function FavoritesPage() {
  ...
  return <main className="ac-page-copy min-h-screen bg-[#07080d] text-white">
    ...
    <section className="mx-auto w-full max-w-6xl px-4 py-10 md:px-8">
      ...
      </div> : <div className="mt-10 rounded-[2rem] bg-white/[0.045] p-8 text-center shadow-[0_18px_60px_rgba(0,0,0,.18)]"><div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-red-500/10 text-red-500"><EmptyStar /></div><h2 className="mt-4 text-2xl font-black">Пока ничего не сохранено</h2><p className="mt-2 text-white/55">Нажмите красную звезду на карточке автомобиля.</p><Link href="/cars" className="avto-button mt-6 inline-block rounded-2xl px-6 py-4 font-black">Открыть каталог</Link></div>}
    </section>
  </main>;
}
