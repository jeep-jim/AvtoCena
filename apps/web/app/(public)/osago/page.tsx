...
import { AFFILIATE_LINK_REL, OSAGO_AFFILIATE_URL } from "@/lib/affiliate-links";

export const metadata: Metadata = {
  title: "ОСАГО — АвтоЦена",
  description: "Переход к оформлению ОСАГО через сайт АвтоЦены.",
};
    ...
    <main className="ac-page-copy min-h-screen bg-[#1a2029] text-white">
      ...
      <section className="mx-auto flex min-h-[calc(100vh-88px)] w-full max-w-3xl items-center px-4 py-12 md:px-8">
        <div className="w-full rounded-[2rem] bg-[var(--ac-surface)] p-6 text-[var(--ac-text)] md:p-9">
          ...
          <h1 className="mt-2 text-3xl font-black tracking-[-.035em] md:text-5xl">Оформление ОСАГО</h1>
          <p className="mt-4 text-base font-medium leading-7 text-[var(--ac-muted)]">
            Вы перешли из сервиса АвтоЦена. Продолжите на странице партнёра, чтобы рассчитать и выбрать подходящий вариант ОСАГО.
          </p>
          <div className="mt-7 grid gap-3 sm:grid-cols-2">
            <a href={OSAGO_AFFILIATE_URL} target="_blank" rel={AFFILIATE_LINK_REL} className="ac-colored-button flex min-h-14 items-center justify-center rounded-2xl bg-red-500 px-5 text-center text-base font-black text-white">
              Перейти к расчёту ОСАГО
            </a>
