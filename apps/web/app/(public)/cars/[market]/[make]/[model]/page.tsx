...
async function query(props: any) { const p = await props.params; if (!marketLanding(p.market)) notFound(); return { ...await props.searchParams, market: p.market, make: p.make, model: p.model }; }
