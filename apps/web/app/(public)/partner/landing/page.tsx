...
export default function PartnerLandingPage() {
  return (
    <PartnerShell title="Зарабатывайте на заявках" subtitle="Вы приводите клиента на расчёт авто под бюджет. Мы доводим до договора и сделки.">
      <div className="grid gap-5 lg:grid-cols-[1fr_420px]">
        <div className="glass rounded-[2rem] p-6 md:p-8">
          <div className="text-6xl font-black tracking-[-0.06em]">{money(10000)} ₽</div>
          <div className="mt-4 text-xl font-black text-white/72">выплата за каждый, подписанный договор</div>
