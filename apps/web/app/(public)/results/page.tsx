    ...
    <section className="mx-auto w-full max-w-[1450px] px-4 py-7 md:px-8 md:py-10">
      ...
      <section className="mt-9 min-w-0">
        <div className="grid min-w-0 grid-cols-[minmax(0,1fr)_82px] items-start gap-x-3 gap-y-2 md:grid-cols-[minmax(0,1fr)_112px] md:gap-x-6">
          <h2 className="min-w-0 text-[36px] font-black leading-[.94] tracking-[-0.045em] md:text-6xl">Актуальные автомобили</h2>
          <Link href="/cars" className="flex min-h-16 w-[82px] items-center justify-center self-start rounded-2xl bg-white/[0.06] px-2 py-2 text-center text-sm font-black leading-[1.05] md:w-[112px] md:px-4 md:text-base"><span>Весь<br />каталог</span></Link>
