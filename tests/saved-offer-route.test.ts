...
test("save endpoint checks session, role, origin and input; recalculates server-side before writing",async()=>{
 ...
 const sources:Record<string,string>={
  ...
  "@/lib/catalog/saved-offer-calculation":`export {cleanSavedDraft,SavedCalculationConflict} from '${path.resolve('apps/web/lib/catalog/saved-offer-calculation.ts')}';export const saveOfferCalculation=async(offer,draft,calculation,userId,version)=>{const s=globalThis.__savedRouteTest;s.saves++;s.saved={draft,calculation,userId,version};return {...s.saved,version:'v2',savedAt:'2026-09-20T10:00:00Z'};};`
 };
