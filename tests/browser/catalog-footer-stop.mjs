...
await build({entryPoints:['tests/browser/catalog-footer-stop-fixture.tsx'],bundle:true,format:'iife',jsx:'automatic',outfile:`${out}/app.js`});
...
const results=[];
try {
 for(const width of [390,767,1280]) {
