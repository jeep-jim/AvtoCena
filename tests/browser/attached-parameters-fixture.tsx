...
const initial = {year:'2026',engineCc:'1498',fuel:kind==='hybrid'?'hybrid':'petrol',powerHp:'160',powerKw:kind==='hybrid'?'':'118',vehicleCategory:kind==='n1'?'N1':'M1',productionMonth:'',productionDay:'',hybridKind:kind==='hybrid'?'other_hybrid':'combustion',power30MinKw:kind==='hybrid'?'50':'',icePowerKw:kind==='hybrid'?'100':'',grossVehicleWeightKg:kind==='n1'?'2800':''};
function App(){return <main className="ac-offer-page ac-page-copy" style={{padding:16,minHeight:'100vh'}}>
 <div style={{maxWidth:390,margin:'40px auto 0'}}>
  <InlineOfferParameters offerId="qa-attached" initial={initial} showCommercial={kind==='n1'} isPickup={kind==='n1'} price={<div className="ac-offer-price-panel" style={{padding:16,borderRadius:20,background:'var(--ac-surface-2)'}}><span>Проверка интерфейса</span><br/><strong style={{fontSize:28}}>4 333 490 ₽</strong></div>}>
