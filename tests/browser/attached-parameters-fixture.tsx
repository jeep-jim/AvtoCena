...
import {OfferMobileActions, OfferDesktopActions} from '../../apps/web/components/catalog/OfferContactActions';
...
function App(){if(kind==='offer-actions')return <main style={{padding:16}}><OfferMobileActions/><OfferDesktopActions/></main>;if(kind.startsWith('alerts'))return <PublicHeader backHref="/cars"/>;
