...
function App(){if(kind==='offer-actions')return <main className="ac-offer-page" style={{padding:16}}><div className="ac-offer-layout grid min-w-0 gap-3 xl:gap-6 xl:grid-cols-[minmax(0,1.55fr)_minmax(390px,.75fr)]">
 ...
 <div data-test-sidebar><InlineOfferParameters offerId="qa-layout" initial={initial} price={<div data-test-price className="ac-offer-price-panel" style={{height:80}}>3 266 183 ₽</div>} afterPrice={<OfferMobileActions/>}><OfferDesktopActions/></InlineOfferParameters></div></div><OfferContactActionsStyles/></main>;if(kind.startsWith('alerts'))return <PublicHeader backHref="/cars"/>;
