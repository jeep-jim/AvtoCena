...
function App(){return <><PublicHeader/><main style={{paddingTop:96}} className="ac-offer-page mx-auto max-w-[1500px] p-4 md:p-8"><CitySelector value="" onChange={()=>{}}/><div className="mt-6 max-w-[960px]"><OfferDesktopActions {...favorite} position="below"/><OfferMobileActions {...favorite}/><div data-spec-desktop data-open="false"/><div style={{width:390,maxWidth:"100%"}}><OfferDesktopActions {...favorite}/></div>{staff?<OfferPdfButton offerId="qa-owner" draft={{year:'2026'}}/>:null}</div><div className="mt-6 max-w-sm"><CatalogBrandMultiSelect value="" options={[{value:'Abarth',label:'Abarth'},{value:'Acura',label:'Acura'}]} contextQuery="" onChange={()=>{}}/></div><OfferContactActionsStyles/></main></>}
