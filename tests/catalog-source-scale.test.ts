...
test("non-whitelisted source ids and source links are rejected centrally", () => {
  ...
  assert.equal(isAllowedCatalogSourceUrl("japan", "retired_japan_source", "https://retired.example/world/japan/honda/fit/8504718/"), false);
...
test("Japan generic registry excludes retired provider; ProAuctions runs separately", () => {
