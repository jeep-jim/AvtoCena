...
test("owner Audi A3 quote: complete cost 2400800, initial 250000, balance 2150800", () => {
 ...
 assert.equal(result.totalRub,2400800);
 assert.equal(result.paymentPlan.contractInitialPaymentRub,250000);
 assert.equal(result.paymentPlan.remainingAfterInitialRub,2150800);
 ...
 assert.equal(changed.paymentPlan.remainingAfterInitialRub,2210800);
});
