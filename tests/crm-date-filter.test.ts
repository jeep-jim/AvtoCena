...
test('date filter matches displayed Moscow day and keeps access/archive filters',()=>{
 const rows=[
  {id:'before',createdAt:'2026-09-23T20:59:59Z',assignedManagerId:'m'},
  {id:'start',createdAt:'2026-09-23T21:00:00Z',assignedManagerId:'m'},
  {id:'end',createdAt:'2026-09-24T20:59:59Z',assignedManagerId:'m'},
  {id:'next',createdAt:'2026-09-24T21:00:00Z',assignedManagerId:'m'},
