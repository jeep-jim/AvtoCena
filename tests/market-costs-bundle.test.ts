...
test('six-market migration changes only requested costs, preserves history, is idempotent and honors later CRM edits',()=>{
 ...
 for(const m of result.markets){
  ...
  assert.equal(v.exchangeRateReservePercent,2);
...
test('every active market quote keeps the full car price, with separate 2% FX reserve, keeping commission and 50k bundle',()=>{
