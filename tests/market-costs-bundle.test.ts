...
test('every active market quote is full car price plus costs, one 50k bundle, no extra advance or note',()=>{
 for(const m of seeds){
  ...
  assert.ok(!quote.breakdown.some(l=>['security-deposit','sbkts','epts'].includes(l.id)));
