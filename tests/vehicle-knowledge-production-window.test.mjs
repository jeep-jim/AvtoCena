...
test('stable vehicle knowledge is versioned in GitHub instead of Object Storage', () => {
  ...
  assert.doesNotMatch(workflow, /YC_OBJECT_STORAGE_BUCKET|YC_OBJECT_STORAGE_ACCESS_KEY_ID|YC_OBJECT_STORAGE_SECRET_ACCESS_KEY/);
});
