...
export async function openAlice(){
 ...
 try {
 const context=await browser.newContext({viewport:{width:420,height:640},locale:'ru-RU',acceptDownloads:false,serviceWorkers:'block'});
 ...
 return {
  async start(prompt){
   await page.goto('https://alice.yandex.ru/',{waitUntil:'domcontentloaded',timeout:25000});
   await check();
  ...
  async frame(){await check();return page.screenshot({type:'jpeg',quality:65,timeout:5000});},
